...
`,Us=new Set(["id","require"]),ys=new Set(["add","load","update","draw","destroy","inspect"]);function kr(i){return i==="pressed"||i==="rpressed"?"down":i==="released"?"up":i}a(kr,"processButtonState");function bs(i){i.requestFullscreen?i.requestFullscreen():i.webkitRequestFullscreen&&i.webkitRequestFullscreen()}a(bs,"enterFullscreen");function xs(){document.exitFullscreen?document.exitFullscreen():document.webkitExitFullScreen&&document.webkitExitFullScreen()}a(xs,"exitFullscreen");function vs(){return document.fullscreenElement||document.webkitFullscreenElement}a(vs,"getFullscreenElement");function Ye(i){switch(i){case"topleft":return f(-1,-1);case"top":return f(0,-1);case"topright":return f(1,-1);case"left":return f(-1,0);case"center":return f(0,0);case"right":return f(1,0);case"botleft":return f(-1,1);case"bot":return f(0,1);case"botright":return f(1,1);default:return i}}a(Ye,"originPt");function Gr(){return new AudioBuffer({length:1,numberOfChannels:1,sampleRate:44100})}a(Gr,"createEmptyAudioBuffer");var to=a((i={})=>{let t=(()=>{var s,o,d;let e=(s=i.root)!=null?s:document.body;e===document.body&&(document.body.style.width="100%",document.body.style.height="100%",document.body.style.margin="0px",document.documentElement.style.width="100%",document.documentElement.style.height="100%");let n=(o=i.canvas)!=null?o:(()=>{let h=document.createElement("canvas");return e.appendChild(h),h})(),r=(d=i.scale)!=null?d:1;i.width&&i.height&&!i.stretch&&!i.letterbox?(n.width=i.width*r,n.height=i.height*r):(n.width=n.parentElement.offsetWidth,n.height=n.parentElement.offsetHeight);let c=["outline: none","cursor: default"];i.crisp&&(c.push("image-rendering: pixelated"),c.push("image-rendering: crisp-edges")),n.style=c.join(";"),n.setAttribute("tabindex","0");let u=n.getContext("webgl",{antialias:!0,depth:!0,stencil:!0,alpha:!0,preserveDrawingBuffer:!0});return{canvas:n,scale:r,gl:u,keyStates:{},mouseStates:{},charInputted:[],isMouseMoved:!1,isKeyPressed:!1,isKeyPressedRepeat:!1,isKeyReleased:!1,mousePos:f(0,0),mouseDeltaPos:f(0,0),time:0,realTime:0,skipTime:!1,dt:0,numFrames:0,isTouch:"ontouchstart"in window||navigator.maxTouchPoints>0,loopID:null,stopped:!1,paused:!1,fpsCounter:new Be,loaded:!1}})(),l=(()=>{var d;let e=t.gl,n=cn(sn,on),r=Ke(new ImageData(new Uint8ClampedArray([255,255,255,255]),1,1)),c=(d=i.background)!=null?d:E(0,0,0);if(i.background){let h=v.fromArray(i.background);e.clearColor(h.r/255,h.g/255,h.b/255,1)}e.enable(e.BLEND),e.enable(e.SCISSOR_TEST),e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);let u=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,u),e.vertexAttribPointer(0,3,e.FLOAT,!1,je*4,0),e.enableVertexAttribArray(0),e.vertexAttribPointer(1,2,e.FLOAT,!1,je*4,12),e.enableVertexAttribArray(1),e.vertexAttribPointer(2,4,e.FLOAT,!1,je*4,20),e.enableVertexAttribArray(2),e.bufferData(e.ARRAY_BUFFER,bt*4,e.DYNAMIC_DRAW),e.bindBuffer(e.ARRAY_BUFFER,null);let s=e.createBuffer();e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,s),e.bufferData(e.ELEMENT_ARRAY_BUFFER,bt*2,e.DYNAMIC_DRAW),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,null);let o=Ke(new ImageData(new Uint8ClampedArray([128,128,128,255,190,190,190,255,190,190,190,255,128,128,128,255]),2,2),{wrap:"repeat",filter:"nearest"});return{drawCalls:0,lastDrawCalls:0,defShader:n,curShader:n,defTex:r,curTex:r,curUniform:{},vbuf:u,ibuf:s,vqueue:[],iqueue:[],transform:new R,transformStack:[],bgTex:o,width:i.width,height:i.height,viewport:{x:0,y:0,width:e.drawingBufferWidth,height:e.drawingBufferHeight}}})();Un();let w=(()=>{let e=new(window.AudioContext||window.webkitAudioContext),n=e.createGain();n.connect(e.destination);let r={buf:Gr()};return e.decodeAudioData(Mr.buffer.slice(0),c=>{r.buf=c},()=>{throw new Error("Failed to load burp.")}),{ctx:e,masterNode:n,burpSnd:r}})(),U={numLoading:0,numLoaded:0,urlPrefix:"",sprites:{},sounds:{},shaders:{},fonts:{}},p={events:{},objEvents:{},root:En([]),timers:new $,layers:{},defLayer:null,gravity:Vr,on(e,n){return this.events[e]||(this.events[e]=new $),this.events[e].pushd(n)},trigger(e,...n){this.events[e]&&this.events[e].forEach(r=>r(...n))},scenes:{},logs:[],cam:{pos:ot(),scale:f(1),angle:0,shake:0,transform:new R}};function S(e){return U.numLoading++,new Promise((n,r)=>{e.then(n).catch(c=>{C.error(c),r(c)}).finally(()=>{U.numLoading--,U.numLoaded++})})}a(S,"load");function A(){return U.numLoaded/(U.numLoading+U.numLoaded)}a(A,"loadProgress");function q(e){return e!==void 0&&(U.urlPrefix=e),U.urlPrefix}a(q,"loadRoot");function V(e){let n=U.urlPrefix+e;return fetch(n).then(r=>{if(!r.ok)throw new Error(`Failed to fetch ${n}`);return r})}a(V,"fetchURL");function N(e){let n=new Image;return n.src=ur(e)?e:U.urlPrefix+e,n.crossOrigin="anonymous",new Promise((r,c)=>{n.onload=()=>r(n),n.onerror=()=>c(`Failed to load image from "${e}"`)})}a(N,"loadImg");function X(e,n,r,c,u={}){return S(N(n).then(s=>{var d;let o=Nr(Ke(s,u),r,c,(d=u.chars)!=null?d:Ar);return e&&(U.fonts[e]=o),o}))}a(X,"loadFont");function Y(e){var n;return(n=U.sprites[e])!=null?n:null}a(Y,"getSprite");function an(e){var n;return(n=U.sounds[e])!=null?n:null}a(an,"getSound");function xt(e){var n;return(n=U.fonts[e])!=null?n:null}a(xt,"getFont");function vt(e){var n;return(n=U.shaders[e])!=null?n:null}a(vt,"getShader");function ve(e=1,n=1,r=0,c=0,u=1,s=1){let o=[],d=u/e,h=s/n;for(let m=0;m<n;m++)for(let g=0;g<e;g++)o.push(new k(r+g*d,c+m*h,d,h));return o}a(ve,"slice");function Ee(e,n){return S(typeof n=="string"?V(n).then(r=>r.json()).then(r=>Ee(e,r)):J(null,e).then(r=>{let c={},u=r.tex.width,s=r.tex.height;for(let o in n){let d=n[o],h={tex:r.tex,frames:ve(d.sliceX,d.sliceY,d.x/u,d.y/s,d.width/u,d.height/s),anims:d.anims};U.sprites[o]=h,c[o]=h}return c}))}a(Ee,"loadSpriteAtlas");function Te(e,n,r={}){let c=Ke(n,r),u=ve(r.sliceX||1,r.sliceY||1),s={tex:c,frames:u,anims:r.anims||{}};return e&&(U.sprites[e]=s),s}a(Te,"loadRawSprite");function J(e,n,r={sliceX:1,sliceY:1,anims:{}}){return S(new Promise((c,u)=>{if(!n)return u(`Expected sprite src for "${e}"`);typeof n=="string"?N(n).then(s=>c(Te(e,s,r))).catch(u):c(Te(e,n,r))}))}a(J,"loadSprite");function $e(e,n){return S(new Promise((r,c)=>{V(n).then(u=>u.json()).then(u=>sr(this,null,function*(){let s=yield Promise.all(u.frames.map(N)),o=document.createElement("canvas");o.width=u.width,o.height=u.height*u.frames.length;let d=o.getContext("2d");return s.forEach((h,m)=>{d.drawImage(h,0,m*u.height)}),J(e,o,{sliceY:u.frames.length,anims:u.anims})})).then(r).catch(c)}))}a($e,"loadPedit");function Et(e,n,r){return S(new Promise((c,u)=>{J(e,n).then(s=>{V(r).then(o=>o.json()).then(o=>{let d=o.meta.size;s.frames=o.frames.map(h=>new k(h.frame.x/d.w,h.frame.y/d.h,h.frame.w/d.w,h.frame.h/d.h));for(let h of o.meta.frameTags)h.from===h.to?s.anims[h.name]=h.from:s.anims[h.name]={from:h.from,to:h.to,speed:10,loop:!0};c(s)}).catch(u)}).catch(u)}))}a(Et,"loadAseprite");function Se(e,n,r,c=!1){function u(s,o,d){let h=cn(o,d);return s&&(U.shaders[s]=h),h}return a(u,"loadRawShader"),S(new Promise((s,o)=>{if(!n&&!r)return o("no shader");function d(h){return h?V(h).then(m=>m.text()).catch(o):new Promise(m=>m(null))}if(a(d,"resolveUrl"),c)Promise.all([d(n),d(r)]).then(([h,m])=>{s(u(e,h,m))}).catch(o);else try{s(u(e,n,r))}catch(h){o(h)}}))}a(Se,"loadShader");function Ce(e,n){return S(new Promise((r,c)=>{if(!n)return c(`expected sound src for "${e}"`);typeof n=="string"&&V(n).then(u=>u.arrayBuffer()).then(u=>new Promise((s,o)=>w.ctx.decodeAudioData(u,s,o))).then(u=>{let s={buf:u};e&&(U.sounds[e]=s),r(s)}).catch(c)}))}a(Ce,"loadSound");function _r(e="bean"){return J(e,Wr)}a(_r,"loadBean");function Br(e){return e!==void 0&&(w.masterNode.gain.value=z(e,Or,Ir)),w.masterNode.gain.value}a(Br,"volume");function Xe(e,n={loop:!1,volume:1,speed:1,detune:0,seek:0}){var g;if(typeof e=="string"){let y=Xe({buf:Gr()});return Ue(()=>{let x=U.sounds[e];if(!x)throw new Error(`Sound not found: "${e}"`);let W=Xe(x,n);for(let O in W)y[O]=W[O]}),y}let r=w.ctx,c=!1,u=r.createBufferSource();u.buffer=e.buf,u.loop=!!n.loop;let s=r.createGain();u.connect(s),s.connect(w.masterNode);let o=(g=n.seek)!=null?g:0;u.start(0,o);let d=r.currentTime-o,h=null,m={stop(){c||(this.pause(),d=r.currentTime)},play(y){if(!c)return;let x=u;u=r.createBufferSource(),u.buffer=x.buffer,u.loop=x.loop,u.playbackRate.value=x.playbackRate.value,u.detune&&(u.detune.value=x.detune.value),u.connect(s);let W=y!=null?y:this.time();u.start(0,W),d=r.currentTime-W,c=!1,h=null},pause(){c||(u.stop(),c=!0,h=r.currentTime)},isPaused(){return c},paused(){return j("paused()","isPaused()"),this.isPaused()},isStopped(){return c},stopped(){return j("stopped()","isStopped()"),this.isStopped()},speed(y){return y!==void 0&&(u.playbackRate.value=z(y,hs,ds)),u.playbackRate.value},detune(y){return u.detune?(y!==void 0&&(u.detune.value=z(y,fs,ps)),u.detune.value):0},volume(y){return y!==void 0&&(s.gain.value=z(y,Or,Ir)),s.gain.value},loop(){u.loop=!0},unloop(){u.loop=!1},duration(){return e.buf.duration},time(){return c?h-d:r.currentTime-d}};return m.speed(n.speed),m.detune(n.detune),m.volume(n.volume),m}a(Xe,"play");function un(e){return Xe(w.burpSnd,e)}a(un,"burp");function Ke(e,n={}){let r=t.gl,c=r.createTexture();r.bindTexture(r.TEXTURE_2D,c),r.texImage2D(r.TEXTURE_2D,0,r.RGBA,r.RGBA,r.UNSIGNED_BYTE,e);let u=(()=>{var o;switch((o=n.filter)!=null?o:i.texFilter){case"linear":return r.LINEAR;case"nearest":return r.NEAREST;default:return r.NEAREST}})(),s=(()=>{switch(n.wrap){case"repeat":return r.REPEAT;case"clampToEdge":return r.CLAMP_TO_EDGE;default:return r.CLAMP_TO_EDGE}})();return r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,u),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,u),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,s),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,s),r.bindTexture(r.TEXTURE_2D,null),{width:e.width,height:e.height,bind(){r.bindTexture(r.TEXTURE_2D,c)},unbind(){r.bindTexture(r.TEXTURE_2D,null)}}}a(Ke,"makeTex");function cn(e=sn,n=on){let r=t.gl,c,u=ws.replace("{{user}}",e!=null?e:sn),s=gs.replace("{{user}}",n!=null?n:on),o=r.createShader(r.VERTEX_SHADER),d=r.createShader(r.FRAGMENT_SHADER);if(r.shaderSource(o,u),r.shaderSource(d,s),r.compileShader(o),r.compileShader(d),c=r.getShaderInfoLog(o))throw new Error(c);if(c=r.getShaderInfoLog(d))throw new Error(c);let h=r.createProgram();if(r.attachShader(h,o),r.attachShader(h,d),r.bindAttribLocation(h,0,"a_pos"),r.bindAttribLocation(h,1,"a_uv"),r.bindAttribLocation(h,2,"a_color"),r.linkProgram(h),(c=r.getProgramInfoLog(h))&&c!==`
`)throw new Error(c);return{bind(){r.useProgram(h)},unbind(){r.useProgram(null)},send(m){this.bind();for(let g in m){let y=m[g],x=r.getUniformLocation(h,g);typeof y=="number"?r.uniform1f(x,y):y instanceof R?r.uniformMatrix4fv(x,!1,new Float32Array(y.m)):y instanceof v?r.uniform4f(x,y.r,y.g,y.b,y.a):y instanceof Fe?r.uniform3f(x,y.x,y.y,y.z):y instanceof L&&r.uniform2f(x,y.x,y.y)}this.unbind()}}}a(cn,"makeShader");function Nr(e,n,r,c){let u=e.width/n,s=e.height/r,o=1/u,d=1/s,h={},m=c.split("").entries();for(let[g,y]of m)h[y]=f(g%u*o,Math.floor(g/u)*d);return{tex:e,map:h,qw:o,qh:d}}a(Nr,"makeFont");function Tt(e,n,r,c=l.defTex,u=l.defShader,s={}){c=c!=null?c:l.defTex,u=u!=null?u:l.defShader,(c!==l.curTex||u!==l.curShader||!jt(l.curUniform,s)||l.vqueue.length+e.length*je>bt||l.iqueue.length+n.length>bt)&&ln();for(let o of e){let d=r?l.transform:p.cam.transform.mult(l.transform),h=jr(d.multVec2(o.pos.xy()));l.vqueue.push(h.x,h.y,o.pos.z,o.uv.x,o.uv.y,o.color.r/255,o.color.g/255,o.color.b/255,o.opacity)}for(let o of n)l.iqueue.push(o+l.vqueue.length/je-e.length);l.curTex=c,l.curShader=u,l.curUniform=s}a(Tt,"drawRaw");function ln(){if(!l.curTex||!l.curShader||l.vqueue.length===0||l.iqueue.length===0)return;let e=t.gl;l.curShader.send(l.curUniform),e.bindBuffer(e.ARRAY_BUFFER,l.vbuf),e.bufferSubData(e.ARRAY_BUFFER,0,new Float32Array(l.vqueue)),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,l.ibuf),e.bufferSubData(e.ELEMENT_ARRAY_BUFFER,0,new Uint16Array(l.iqueue)),l.curShader.bind(),l.curTex.bind(),e.drawElements(e.TRIANGLES,l.iqueue.length,e.UNSIGNED_SHORT,0),l.curTex.unbind(),l.curShader.unbind(),e.bindBuffer(e.ARRAY_BUFFER,null),e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,null),l.iqueue=[],l.vqueue=[],l.drawCalls++}a(ln,"flush");function He(){t.gl.clear(t.gl.COLOR_BUFFER_BIT),i.background||pe({width:F(),height:G(),quad:new k(0,0,F()*t.scale/Fr,G()*t.scale/Fr),tex:l.bgTex,fixed:!0}),l.drawCalls=0,l.transformStack=[],l.transform=new R}a(He,"frameStart");function ze(){ln(),l.lastDrawCalls=l.drawCalls}a(ze,"frameEnd");function Es(){return l.lastDrawCalls}a(Es,"drawCalls");function jr(e){return f(e.x/F()*2-1,-e.y/G()*2+1)}a(jr,"screen2ndc");function Ts(e){return f((e.x+1)/2*F(),-(e.y-1)/2*G())}a(Ts,"ndc2screen");function Ss(e){l.transform=e.clone()}a(Ss,"applyMatrix");function I(...e){if(e[0]===void 0)return;let n=f(...e);n.x===0&&n.y===0||(l.transform=l.transform.translate(n))}a(I,"pushTranslate");function ne(...e){if(e[0]===void 0)return;let n=f(...e);n.x===1&&n.y===1||(l.transform=l.transform.scale(n))}a(ne,"pushScale");function Cs(e){!e||(l.transform=l.transform.rotateX(e))}a(Cs,"pushRotateX");function Rs(e){!e||(l.transform=l.transform.rotateY(e))}a(Rs,"pushRotateY");function Je(e){!e||(l.transform=l.transform.rotateZ(e))}a(Je,"pushRotateZ");function re(){l.transformStack.push(l.transform.clone())}a(re,"pushTransform");function ie(){l.transformStack.length>0&&(l.transform=l.transformStack.pop())}a(ie,"popTransform");function pe(e){var h;if(e.width===void 0||e.height===void 0)throw new Error('drawUVQuad() requires property "width" and "height".');if(e.width<=0||e.height<=0)return;let n=e.width,r=e.height,u=Ye(e.origin||Ne).scale(f(n,r).scale(-.5)),s=e.quad||new k(0,0,1,1),o=e.color||E(255,255,255),d=(h=e.opacity)!=null?h:1;re(),I(e.pos),Je(e.angle),ne(e.scale),I(u),Tt([{pos:ce(-n/2,r/2,0),uv:f(e.flipX?s.x+s.w:s.x,e.flipY?s.y:s.y+s.h),color:o,opacity:d},{pos:ce(-n/2,-r/2,0),uv:f(e.flipX?s.x+s.w:s.x,e.flipY?s.y+s.h:s.y),color:o,opacity:d},{pos:ce(n/2,-r/2,0),uv:f(e.flipX?s.x:s.x+s.w,e.flipY?s.y+s.h:s.y),color:o,opacity:d},{pos:ce(n/2,r/2,0),uv:f(e.flipX?s.x:s.x+s.w,e.flipY?s.y:s.y+s.h),color:o,opacity:d}],[0,1,3,1,2,3],e.fixed,e.tex,e.shader,e.uniform),ie()}a(pe,"drawUVQuad");function Yr(e){var s;if(!e.tex)throw new Error('drawTexture() requires property "tex".');let n=(s=e.quad)!=null?s:new k(0,0,1,1),r=e.tex.width*n.w,c=e.tex.height*n.h,u=f(1);if(e.tiled){let o=Math.ceil((e.width||r)/r),d=Math.ceil((e.height||c)/c),m=Ye(e.origin||Ne).add(f(1,1)).scale(.5).scale(o*r,d*c);for(let g=0;g<o;g++)for(let y=0;y<d;y++)pe(D(P({},e),{pos:(e.pos||f(0)).add(f(r*g,c*y)).sub(m),scale:u.scale(e.scale||f(1)),tex:e.tex,quad:n,width:r,height:c,origin:"topleft"}))}else e.width&&e.height?(u.x=e.width/r,u.y=e.height/c):e.width?(u.x=e.width/r,u.y=u.x):e.height&&(u.y=e.height/c,u.x=u.y),pe(D(P({},e),{scale:u.scale(e.scale||f(1)),tex:e.tex,quad:n,width:r,height:c}))}a(Yr,"drawTexture");let St=new Set;function hn(e){var c,u;if(!e.sprite)throw new Error('drawSprite() requires property "sprite"');let n=gn(e.sprite,U.sprites);if(!n)if(typeof e.sprite=="string"){St.has(e.sprite)||(St.add(e.sprite),J(e.sprite,e.sprite).then(s=>St.delete(e.sprite)));return}else throw new Error(`sprite not found: "${e.sprite}"`);let r=n.frames[(c=e.frame)!=null?c:0];if(!r)throw new Error(`frame not found: ${(u=e.frame)!=null?u:0}`);Yr(D(P({},e),{tex:n.tex,quad:r.scale(e.quad||new k(0,0,1,1)),uniform:e.uniform}))}a(hn,"drawSprite");function Re(e,n,r,c,u,s=1){c=ue(c%360),u=ue(u%360),u<=c&&(u+=Math.PI*2);let o=Math.ceil(Math.max(Math.sqrt(n+r)*3*(s||1),16)),d=(u-c)/o,h=[];for(let m=c;m<u;m+=d)h.push(e.add(n*Math.cos(m),r*Math.sin(m)));return h.push(e.add(n*Math.cos(u),r*Math.sin(u))),h}a(Re,"getArcPts");function Q(e){if(e.width===void 0||e.height===void 0)throw new Error('drawRect() requires property "width" and "height".');if(e.width<=0||e.height<=0)return;let n=e.width,r=e.height,u=Ye(e.origin||Ne).add(1,1).scale(f(n,r).scale(-.5)),s=[f(0,0),f(n,0),f(n,r),f(0,r)];if(e.radius){let o=Math.min(Math.min(n,r)/2,e.radius);s=[f(o,0),f(n-o,0),...Re(f(n-o,o),o,o,270,360),f(n,o),f(n,r-o),...Re(f(n-o,r-o),o,o,0,90),f(n-o,r),f(o,r),...Re(f(o,r-o),o,o,90,180),f(0,r-o),f(0,o),...Re(f(o,o),o,o,180,270)]}Qe(D(P({},e),{offset:u,pts:s}))}a(Q,"drawRect");function We(e){let{p1:n,p2:r}=e;if(!n||!r)throw new Error('drawLine() requires properties "p1" and "p2".');let c=e.width||1,u=r.sub(n).unit().normal().scale(c*.5),s=[n.sub(u),n.add(u),r.add(u),r.sub(u)].map(o=>{var d,h;return{pos:ce(o.x,o.y,0),uv:f(0),color:(d=e.color)!=null?d:v.WHITE,opacity:(h=e.opacity)!=null?h:1}});Tt(s,[0,1,3,1,2,3],e.fixed,l.defTex,e.shader,e.uniform)}a(We,"drawLine");function dn(e){let n=e.pts;if(!n)throw new Error('drawLines() requires property "pts".');if(!(n.length<2))if(e.radius&&n.length>=3){let r=n[0].dist(n[1]);for(let u=1;u<n.length-1;u++)r=Math.min(n[u].dist(n[u+1]),r);let c=Math.min(e.radius,r/2);We(D(P({},e),{p1:n[0],p2:n[1]}));for(let u=1;u<n.length-2;u++){let s=n[u],o=n[u+1];We(D(P({},e),{p1:s,p2:o}))}We(D(P({},e),{p1:n[n.length-2],p2:n[n.length-1]}))}else for(let r=0;r<n.length-1;r++)We(D(P({},e),{p1:n[r],p2:n[r+1]}))}a(dn,"drawLines");function fn(e){if(!e.p1||!e.p2||!e.p3)throw new Error('drawPolygon() requires properties "p1", "p2" and "p3".');return Qe(D(P({},e),{pts:[e.p1,e.p2,e.p3]}))}a(fn,"drawTriangle");function Ct(e){if(!e.radius)throw new Error('drawCircle() requires property "radius".');e.radius!==0&&pn(D(P({},e),{radiusX:e.radius,radiusY:e.radius,angle:0}))}a(Ct,"drawCircle");function pn(e){var n,r;if(e.radiusX===void 0||e.radiusY===void 0)throw new Error('drawEllipse() requires properties "radiusX" and "radiusY".');e.radiusX===0||e.radiusY===0||Qe(D(P({},e),{pts:Re(f(0),e.radiusX,e.radiusY,(n=e.start)!=null?n:0,(r=e.end)!=null?r:360,e.resolution),radius:0}))}a(pn,"drawEllipse");function Qe(e){var r,c;if(!e.pts)throw new Error('drawPolygon() requires property "pts".');let n=e.pts.length;if(!(n<3)){if(re(),I(e.pos),ne(e.scale),Je(e.angle),I(e.offset),e.fill!==!1){let u=(r=e.color)!=null?r:v.WHITE,s=e.pts.map(d=>{var h;return{pos:ce(d.x,d.y,0),uv:f(0,0),color:u,opacity:(h=e.opacity)!=null?h:1}}),o=[...Array(n-2).keys()].map(d=>[0,d+1,d+2]).flat();Tt(s,(c=e.indices)!=null?c:o,e.fixed,l.defTex,e.shader,e.uniform)}e.outline&&dn({pts:[...e.pts,e.pts[0]],radius:e.radius,width:e.outline.width,color:e.outline.color,uniform:e.uniform,fixed:e.fixed}),ie()}}a(Qe,"drawPolygon");function mn(e,n){n.pos&&(e.pos=e.pos.add(n.pos)),n.scale&&(e.scale=e.scale.scale(f(n.scale))),n.angle&&(e.angle+=n.angle),n.color&&(e.color=e.color.mult(n.color)),n.opacity&&(e.opacity*=n.opacity)}a(mn,"applyCharTransform");let wn=/\[(?<text>[^\]]*)\]\.(?<style>[\w\.]+)+/g;function $r(e){let n={},r=e.replace(wn,"$1"),c=0;for(let u of e.matchAll(wn)){let s=u.groups.style.split("."),o=u.index-c;for(let d=o;d<u.index+u.groups.text.length;d++)n[d]={localIdx:d-o,styles:s};c+=3+u.groups.style.length}return{charStyleMap:n,text:r}}a($r,"compileStyledText");function gn(e,n,r){if(e)return typeof e=="string"?n[e]:e;if(r)return n[r]}a(gn,"findAsset");function me(e){var Qn,Zn,er;if(e.text===void 0)throw new Error('formatText() requires property "text".');let n=gn((Qn=e.font)!=null?Qn:i.font,U.fonts,ms);if(!n)throw new Error(`Font not found: ${e.font}`);let{charStyleMap:r,text:c}=$r(e.text+""),u=c.split(""),s=n.qw*n.tex.width,o=n.qh*n.tex.height,d=e.size||o,h=f(d/o).scale(f(e.scale||1)),m=h.x*s+((Zn=e.letterSpacing)!=null?Zn:0),g=h.y*o+((er=e.lineSpacing)!=null?er:0),y=0,x=g,W=0,O=[],M=[],ee=null,te=0;for(;te<u.length;){let oe=u[te];oe===`
